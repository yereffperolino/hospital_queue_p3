<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-2xl text-slate-800">Add New Clinic</h2>
    </x-slot>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" 
                        class="block mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description') }}</textarea>
